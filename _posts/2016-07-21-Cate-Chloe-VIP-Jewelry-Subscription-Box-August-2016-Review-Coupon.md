...
I love how it's set off-center with the double strand on one side and a single strand on the other, and then topped off with a single pearl above the leaf.
