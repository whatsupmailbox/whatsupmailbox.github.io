...
<p><i class="icon-exclamation-sign"></i><b> My Thoughts:</b> Although I kind of expected more from their first launch box and was also hoping for more lifestyle items, I'll still be using everything in the box so I'm happy with that. I think if they included a cute and well made earring instead of the ones they sent out, it would have been a better box. The total value came up to $21.44 which almost made it even with the $21.99 cost of subscription. The value versus cost might not be great, but I'll give them another chance since this is their first launch box. Let's hope next month brings better products and value!</p>
<br>
