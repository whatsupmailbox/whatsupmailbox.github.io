...
<p>I haven't reviewed my Popsugar boxes in awhile due to the holidays plus the fact that I end up using all the items before I even get to take pictures of them, but that will change, regular reviews will be coming your way starting from this month! =)</p>
...
<p>The weekly pages include check boxes so you can write down to-do lists as well, how thoughtful.</p>
...
<p>The monthly pages are roomy enough for you to write down important events and they also state the holidays in the appropriate dates (with a green tag on it too!).</p>
...
<TABLE  BORDER="5" style="width:60%">
  ...
  <TR>
   ...
   <TR>
      <TD>Not Soap, Radio Bath & Shower Gel Gift Set</TD>
      <TD>$22</TD>
   </TR>
    <TR>
