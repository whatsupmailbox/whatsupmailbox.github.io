...
<p><i class="icon-exclamation-sign"></i><b> My Thoughts:</b> This month Glossybox redeemed itself from <a href="http://whatsupmailbox.com/subscriptions/reviews/Glossybox-Subscription-Box-November-2015-Review/" target="_blank">last month's box. The items this time have a better variety and the brands featured are great as well, plus a special designed box too! What's even more amazing is that this month included 4 full-sized items out of the 5 that they sent out, and the 1 non full-size was half the size of full, so that's still a substantial size, love it! I'll be using everything in this box, but my winning item has got to be the Orogold hand cream. So happy with this month's box, I'm not excited again to see what Glossybox has in plan for January!</p>
